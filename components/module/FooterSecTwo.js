...
const FooterSecTwo = () => {
    return (
        <div className='w-full bg-mulberry'>

        
        <div className='flex lg:flex-row flex-col px-8 md:px-10 lg:px-16 mx-auto 
        py-12 justify-between text-white gap-6 max-w-640 md:max-w-none'>
            ...
            <div className='flex flex-col gap-6 max-w-max mt-3 lg:mt-0'>
                ...
                <div className='grid grid-cols-2 grid-rows-3 md:max-w-600 lg:max-w-none '>
                    ...
                    <div className='md:row-start-1 row-start-3 col-span-2 mt-3 md:mt-0'>
                        <button className='border md:w-28 w-full py-3'>Subscribe</button>
                    </div>  
                    <div class="mb-[0.125rem] block min-h-[1.5rem] pl-[1.5rem] mt-3 row-start-2 col-span-2 md:col-start-1 col-end-3">
                        <input
